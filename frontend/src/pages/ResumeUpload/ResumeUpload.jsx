...
function ResumeUpload() {
    return (
        <div>
            <Navbar />
            <div className="w-full mt-56 flex justify-center">
            ...
            <div className='p-5 w-full '>
                <div className=' p-3 bg-gray-50 rounded-2xl border border-gray-300 gap-3 grid border-dashed'>
                    ...
                    <div className='flex justify-around flex-wrap'>
                        {templates.map((item) => {
                            return <PreviewCard value={item.value} imageSrc={item.imageSrc} previewLink={item.previewLink} />
                        })}
                    </div>
                    <div className='flex justify-end mt-14'>
                        <button type="button" class="text-white bg-gradient-to-r from-cyan-500 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-cyan-300 dark:focus:ring-cyan-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2">Continue</button>
                    </div>
                </div>
            </div>
        </div>
...
function PreviewCard({ value, imageSrc, previewLink }) {
    return (
        <div className='m-2'>
